...
const UpdateOrder = () => {
    ...
    return (
        <>
            <MetaData title="Admin: Update Order | Shop4ever" />
                                    ...
                                    <div className="flex flex-col sm:flex-row min-w-full shadow-lg rounded-lg bg-white px-2 py-5" key={_id}>
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:w-1/2 gap-1">
                                            ...
                                            <div className="flex flex-col gap-1 overflow-hidden">
                                                ...
                                                <p className="text-xs text-gray-600">Price: MAD {price.toLocaleString()}</p>
                                                <span className="font-medium">Total: MAD {(quantity * price).toLocaleString()}</span>
                                            </div>
                                        </div>
