...
const Payment = () => {
    ...
    return (
        <>
            <MetaData title="Shop4ever: Secure Payment | Paytm" />
                        ...
                        <Stepper activeStep={3}>
                            <div className="w-full bg-white">
                                ...
                                <form onSubmit={(e) => submitHandler(e)} autoComplete="off" className="flex flex-col justify-start gap-2 w-full mx-8 my-4 overflow-hidden">
                                    ...
                                    <input type="submit" value={`Pay MAD ${totalPrice.toLocaleString()}`} disabled={payDisable ? true : false} className={`${payDisable ? "bg-primary-grey cursor-not-allowed" : "bg-primary-orange cursor-pointer"} w-1/2 sm:w-1/4 my-2 py-3 font-medium text-white shadow hover:shadow-lg rounded-sm uppercase outline-none`} />
